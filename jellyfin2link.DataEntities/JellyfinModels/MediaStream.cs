    ...
    public class MediaStream
    {
        ...
        internal string GetResolutionText()
        {
            ...
            if (Width <= 256 && Height <= 144)
                return IsInterlaced ? "144i" : "144p";
            else if (Width <= 426 && Height <= 240)
                return IsInterlaced ? "240i" : "240p";
            else if (Width <= 640 && Height <= 360)
                return IsInterlaced ? "360i" : "360p";
            else if (Width <= 682 && Height <= 384)
                return IsInterlaced ? "384i" : "384p";
            else if (Width <= 720 && Height <= 404)
                return IsInterlaced ? "404i" : "404p";
            else if (Width <= 854 && Height <= 480)
                return IsInterlaced ? "480i" : "480p";
            else if (Width <= 960 && Height <= 544)
                return IsInterlaced ? "540i" : "540p";
            else if (Width <= 1024 && Height <= 576)
                return IsInterlaced ? "576i" : "576p";
            else if (Width <= 1280 && Height <= 962)
                return IsInterlaced ? "720i" : "720p";
            else if (Width <= 2560 && Height <= 1440)
                return IsInterlaced ? "1080i" : "1080p";
            else if (Width <= 4096 && Height <= 3072)
                return "4K";
            else if (Width <= 8192 && Height <= 6144)
                return "8K";
        ...
        public (VideoRange VideoRange, VideoRangeType VideoRangeType) GetVideoColorRange()
        {
            ...
            var isDoViProfile = dvProfile == 5
                             || dvProfile == 7
                             || dvProfile == 8
                             || dvProfile == 10;

            var isDoViFlag = rpuPresentFlag
                          && blPresentFlag
                          && (dvBlCompatId == 0
                           || dvBlCompatId == 1
                           || dvBlCompatId == 2
